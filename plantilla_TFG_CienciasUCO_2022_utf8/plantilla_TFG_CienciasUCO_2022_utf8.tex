...
\newcommand{\titulacion}{Titulación}                  % Grado de Biología
\usepackage{siunitx}
                                                      % Grado de Bioquímica
...
\newcommand{\titulo}{Título del Trabajo Fin de Grado} % Título
\newcommand{\codigo}{Código asignado a este TFG}      % Código
\newcommand{\tipo}{Tipología del trabajo}             % Trabajo teórico--práctico general
...
% No cambiar  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{portada}   % Dejar esta línea (incluirá el fichero 		 
%                                  portada.tex
% 	                              proporcionado, que no hay que modificar
% Fin de No cambiar %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\include{agradecimientos} % Agradecimientos y/o dedicatoria si procede (si no comentar esta línea)

% No cambiar  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{indices}  % Dejar esta línea (incluirá el fichero 		 
%                                  indices.tex
% 	                              proporcionado, que no hay que modificar
% Fin de No cambiar %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\include{resumen}          % Resumen (insertar en el fichero resumen.tex proporcionado,
%                                     el resumen en español e inglés)

% empiezan los capítulos
\include{capitulo1}       % Añadir los diferentes capítulos con el mismo formato que tiene
...
\include{conclusion}       % Conclusiones (insertar en el fichero conclusion.tex proporcionado,
%                                          las conclusiones en español e inglés)
 
\include{bibliografia}     % Bibliografía (insertar en el fichero bibliografia.tex proporcionado, 
...
\appendix
\include{anexo1}    % Añadir los diferentes anexos, si los hubiera, con el mismo formato que tiene
